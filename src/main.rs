...
async fn get_horde_id(api_key: String, selector: &str, prompt: &str) -> String{
    let mut body = "this is impossible to ever see in the console. wtf have you done.";
...
async fn main() -> Result<(), Error> {
    ...
    let message_id = get_horde_id(api_key, "text", "").await;
